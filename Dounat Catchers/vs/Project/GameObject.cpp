...
void Engine::GameObject::SetIsDie()
{
	this->state = Engine::GameObjectState::DIE;
}
...
BoundingBox* Engine::GameObject::GetBoundingBox()
{
	return sprite->GetBoundingBox();
}

vec2 Engine::GameObject::GetRotatedPoint(float x, float y)
{
	return sprite->GetRotatedPoint(x, y);
}

void Engine::GameObject::SetBoundingBoxSize(float w, float h)
{
	return sprite->SetBoundingBoxSize(w, h);
}

void Engine::GameObject::SetFlipHorizontal(bool flipHorizontal)
{
	return sprite->SetFlipHorizontal(flipHorizontal);
}
